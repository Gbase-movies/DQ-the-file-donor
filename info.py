...
DATABASE_NAME = environ.get('DATABASE_NAME', "Swaflixpay")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
VERIFY = bool(environ.get('VERIFY', True))
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'linkyetu.swaflix.xyz')
SHORTLINK_API = environ.get('SHORTLINK_API', '520b9406d887aa0956cb685aafab629ce1a21e61')
IS_SHORTLINK = bool(environ.get('IS_SHORTLINK', False))
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "5")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+swaflixhub')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+swaflixhub')
